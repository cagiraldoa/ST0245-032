...
public class UnaTablaDeHash
{
    ...
    public int get(String k){
        ...
        int laPosicionDeLaTablaDondeEstaLaPersona = funcionHash(k);
        int elNumeroDeTelefono = tabla[laPosicionDeLaTablaDondeEstaLaPersona];
    ...
    public void put(String k, int v){
        int laPosicionDeLaTablaDondeEstaLaPersona = funcionHash(k);
        tabla[laPosicionDeLaTablaDondeEstaLaPersona] = v;
    }
}